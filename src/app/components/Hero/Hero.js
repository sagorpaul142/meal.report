...
import heroCarouselOne from "../../images/hero-carousel/hero-carousel-1.svg"
import heroCarouselTwo from "../../images/hero-carousel/hero-carousel-2.svg"
import heroCarouselThree from "../../images/hero-carousel/hero-carousel-3.svg"
            ...
            >
                    ...
                    <div className="container">
                        <div className="row justify-content-center gy-6 mb-5">
                            ...
                            <div className="col-lg-5 col-md-8">
                                <Image src={heroCarouselOne} alt="" className="img-fluid img"/>
                            </div>
                ...
                <SwiperSlide>
                    <div className="container">
                        <div className="row justify-content-center gy-6 mb-5">
                            <div className="col-lg-5 col-md-8">
                                <Image src={heroCarouselTwo} alt="" className="img-fluid img"/>
                            </div>
                            <div className="col-lg-9 text-center">
                ...
                <SwiperSlide>
                    <div className="container">
                        <div className="row justify-content-center gy-6 mb-5">
                            ...
                            <div className="col-lg-5 col-md-8">
                                <Image src={heroCarouselThree} alt="" className="img-fluid img"/>
                            </div>
